      ...
      <div className="container px-4 md:px-6 py-12 md:py-16 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-xs leading-relaxed">
              Empowering data teams to unlock insights instantly with AI-driven analytics. securely connect, ask, and visualizing your data.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">
            © {new Date().getFullYear()} Aigent Inc. All rights reserved.
          </p>
